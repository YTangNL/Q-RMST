...
#Cvdeath
####
data0 <- read_excel("Reverse_Engineer/IPDfromKM/coordinate/cvd/placebo_cvd.xlsx")
data1 <- read_excel("Reverse_Engineer/IPDfromKM/coordinate/cvd/evolo_cvd.xlsx")
...
write_xlsx(cvd_ipd, "Appendix/cvd_ipd.xlsx")
