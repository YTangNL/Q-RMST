...
#Hospitalization
####
data0 <- read_excel("Reverse_Engineer/IPDfromKM/coordinate/hospital/placebo_hospital.xlsx")
data1 <- read_excel("Reverse_Engineer/IPDfromKM/coordinate/hospital/evolo_hospital.xlsx")
...
write_xlsx(hosp_ipd, "Appendix/hosp_ipd.xlsx")
...
at_risk_matrix <- matrix(hosp_summary$n.risk, ncol = 2, byrow = FALSE)
