...
#Revascularization
####
data0 <- read_excel("Reverse_Engineer/IPDfromKM/coordinate/revasc/placebo_revasc.xlsx")
data1 <- read_excel("Reverse_Engineer/IPDfromKM/coordinate/revasc/evolo_revasc.xlsx")
...
write_xlsx(revasc_ipd, "Appendix/revasc_ipd.xlsx")
...
table(revasc_ipd$status, revasc_ipd$treat)
at_risk_matrix
