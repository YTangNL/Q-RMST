...
#Stroke
####
data0 <- read_excel("Data Simulation/IPDfromKM/coordinate/stroke/placebo_stroke.xlsx")
data1 <- read_excel("Data Simulation/IPDfromKM/coordinate/stroke/evolo_stroke.xlsx")
####
##placebo
####
...
write_xlsx(stroke_ipd, "Appendix/stroke_ipd.xlsx")
