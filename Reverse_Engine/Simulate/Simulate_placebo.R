...
a2 <- c(1.2, 0.8, 1.3, 0.4, 0.9)
a3 <- c(0.8, 0.4, 0.9, 0.1, 1.0)
a4 <- c(0.7, 0.6, 1.0, 0.4, 1.5)
a5 <- c(0.62, 0.75, 0.68, 0.5, 1.6)
...
res[, 1] <- 1:n
t1 <- rexp(n, rate = r[1]* a1[1] * tmp1$rate[1])
t2 <- rexp(n, rate = r[1]* a1[2] * tmp2$rate[1])
t3 <- rexp(n, rate = r[1]* a1[3] * tmp3$rate[1])
t4 <- rexp(n, rate = r[1]* a1[4] * tmp4$rate[1])
t5 <- rexp(n, rate = r[1]* a1[5] * tmp5$rate[1])
...
t1 <- rexp(nnext, rate = r[2] * a2[1] * tmp1$rate[1])
t2 <- rexp(nnext, rate = r[2] * a2[2] * tmp2$rate[1])
t3 <- rexp(nnext, rate = r[2] * a2[3] * tmp3$rate[1])
t4 <- rexp(nnext, rate = r[2] * a2[4] * tmp4$rate[1])
t5 <- rexp(nnext, rate = r[2] * a2[5] * tmp5$rate[1])
tnext <- pmin(t1, t2, t3, t4, t5)
dnext <- 1
dnext[tnext == t1] <- 1
dnext[tnext == t2] <- 2
...
t1 <- rexp(nnext, rate = r[3] * a3[1] * tmp1$rate[1])
t2 <- rexp(nnext, rate = r[3]* a3[2] * tmp2$rate[1])
t3 <- rexp(nnext, rate = r[3] * a3[3] * tmp3$rate[1])
t4 <- rexp(nnext, rate = r[3] * a3[4] * tmp4$rate[1])
t5 <- rexp(nnext, rate = r[3] * a3[5] * tmp5$rate[1])
tnext <- pmin(t1, t2, t3, t4, t5)
dnext <- 1
dnext[tnext == t1] <- 1
dnext[tnext == t2] <- 2
...
t1 <- rexp(nnext, rate = r[4] * a4[1] * tmp1$rate[1])
t2 <- rexp(nnext, rate = r[4] * a4[2] * tmp2$rate[1])
t3 <- rexp(nnext, rate = r[4] * a4[3] * tmp3$rate[1])
t4 <- rexp(nnext, rate = r[4] * a4[4] * tmp4$rate[1])
t5 <- rexp(nnext, rate = r[4] * a4[5] * tmp5$rate[1])
tnext <- pmin(t1, t2, t3, t4, t5)
dnext <- 1
dnext[tnext == t1] <- 1
dnext[tnext == t2] <- 2
...
t1 <- rexp(nnext, rate = r[5] * a5[1] * tmp1$rate[1])
t2 <- rexp(nnext, rate = r[5] * a5[2] * tmp2$rate[1])
t3 <- rexp(nnext, rate = r[5] * a5[3] * tmp3$rate[1])
t4 <- rexp(nnext, rate = r[5] * a5[4] * tmp4$rate[1])
t5 <- rexp(nnext, rate = r[5] * a5[5] * tmp5$rate[1])
tnext <- pmin(t1, t2, t3, t4, t5)
dnext <- 1
dnext[tnext == t1] <- 1
dnext[tnext == t2] <- 2
...
ncum_repo_pla <- c(240,639,765,262,239)
